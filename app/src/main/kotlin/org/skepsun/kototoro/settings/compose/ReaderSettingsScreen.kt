        ...
        Column(
            ...
            SettingsPreferenceGroup(
                ...
                item {
                    ...
                    options = listOf(
                        SettingsChoiceOption(ReadingMode.PAGED.name, stringResource(R.string.novel_mode_paged)),
                        SettingsChoiceOption(ReadingMode.SCROLL.name, stringResource(R.string.novel_mode_scroll)),
                    ),
                    onValueChange = { value ->
