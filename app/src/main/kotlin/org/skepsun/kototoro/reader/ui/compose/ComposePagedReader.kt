...
private sealed interface ReaderCropBoundsState {
...
@Composable
private fun rememberReaderCropBounds(
	uri: Uri?,
...
@Composable
private fun TelephotoCoilReaderImage(
	uri: Uri,
	imageLoader: ImageLoader,
	pageKey: Long,
	zoomMode: ZoomMode?,
...
private const val PAGED_ZOOM_EPSILON = 0.001f
